...
export default function TechStack() {
  ...
  return (
    <section id="tech-stack" className="relative py-40 px-6 md:px-12 lg:px-24">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {techStacks.map((stack, index) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-3xl border ${stack.borderColor} bg-gradient-to-br ${stack.gradient} backdrop-blur-sm p-8 hover:border-white/20 transition-all duration-700 project-spotlight-card`}
            >
                ...
                <div className="space-y-4">
                  {stack.techs.map((tech, techIndex) => (
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      transition={{ delay: index * 0.08 + techIndex * 0.05, duration: 0.6 }}
                      onMouseEnter={playHoverSound}
                    ...
                    >
                      ...
                      <div className="h-1 bg-white/5 rounded-full overflow-hidden">
                        <motion.div
                          ...
                          viewport={{ once: true }}
                          transition={{ delay: index * 0.08 + techIndex * 0.05 + 0.3, duration: 1, ease: [0.22, 1, 0.36, 1] }}
        ...
        >
          <div className="inline-flex items-center gap-8 px-10 py-5 rounded-full bg-gradient-to-r from-cyan-500/5 via-purple-500/5 to-pink-500/5 border border-white/10 backdrop-blur-sm">
